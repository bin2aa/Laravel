        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('client.updatePosts', $post->id) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                @if($post->getFirstMediaUrl('thumbnails'))
                                    <div class="mb-2">
                                        <img src="{{ $post->getFirstMediaUrl('thumbnails') }}" alt="Current Thumbnail"
                            ...
                            <input type="hidden" id="publish_date" name="publish_date"
                                value="{{ $post->getRawOriginal('publish_date') }}">
